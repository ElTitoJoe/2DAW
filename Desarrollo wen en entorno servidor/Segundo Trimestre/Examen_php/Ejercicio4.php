...
/* Tablas */
   ...
   /* ¿Serías capaz de hacer que los desplegables que hicistes en el ejercicio 3 se generan automaticamente con los valores de la tabla?
   */
    </style>

<body>
    <?php
        $llamadaBD=new mysqli("localhost","","","instituto");
    ?>
</body>
</html>